...
import { Tool, VButton } from '../../editorjs-react-tool' // 'editorjs-react-tool'
import ErrorBoundary from './error-boundry'
import { exportComponent } from '../../../utils/utils/component-to-canvas' // '@djitsu/utils'
...
const StyledResult = styled.div`
  &.demo-result {
    ...
    border: 1px solid var(--separtor-color);
    border-left: none;
    border-right: none;
