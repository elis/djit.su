...
import { Divider, Space, List, Row, Col, Statistic } from 'antd'
...
export const TiledViewItem = (props) => (item) =>
  documentItem(props.handleItemClick)(item)

export const ListViewItem = (props) => (item) => (
